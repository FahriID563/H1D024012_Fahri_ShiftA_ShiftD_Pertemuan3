...
# 2. MEMBERSHIP FUNCTION (SESUAI GRAFIK)
...
hasil = stok_simulation.output['stok_makanan']

print("=== HASIL LOGIKA FUZZY ===")
print(f"Barang Terjual : 80")
print(f"Permintaan     : 255")
print(f"Harga Item     : 25.000")
